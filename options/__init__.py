...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='ppst', help='which model to use')
        parser.add_argument('--optimizer', type=str, default='ppst', help='which model to use')
        ...
        parser.add_argument("--netE1", default="StyleGAN2Resnet")
        parser.add_argument("--netE2", default="StyleGAN2Resnet")
        ...
        parser.add_argument('--dataname', type=str, default="results")
        return parser
