...
class TmuxLauncher():
    ...
    def commands(self):
        ...
        return ["python -m torch.distributed.launch --nproc_per_node=1 --master_port='29512' train.py " + str(opt) for opt in opts]

    def test_commands(self):
        opts = self.test_options()
        return ["python -m torch.distributed.launch --nproc_per_node=1 --master_port='29512' test.py " + str(opt) for opt in opts]
